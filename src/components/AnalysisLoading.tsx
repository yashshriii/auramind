  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16 flex flex-col items-center text-center space-y-8">
      ...
      <div className="relative flex items-center justify-center">
        <div className="relative w-16 h-16 rounded-2xl bg-sky-50 border border-sky-200 shadow-md flex items-center justify-center text-sky-600">
          <Brain className="w-8 h-8 text-sky-600 animate-pulse" />
        </div>
      </div>
      ...
      {/* Progress Steps List */}
      <div className="w-full bg-white border border-neutral-200 rounded-2xl p-5 text-left space-y-3.5 shadow-xs text-xs">
